...
int child()
{
  /* this will ignore any SIGINT signals that the child receives */
  signal( SIGINT, SIG_IGN );   /* SIG_DFL to restore default behavior */
  signal( SIGKILL, SIG_IGN );   /* SIG_DFL to restore default behavior */
